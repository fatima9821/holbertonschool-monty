...
The learning objectives include understanding LIFO and FIFO concepts, implementing stacks and queues, and using the extern keyword to share variables between source files in C. The README.md file and header file (monty.h) with include guards are mandatory components of the project.
## Resources
## Read or watch:
